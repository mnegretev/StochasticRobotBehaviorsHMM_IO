...
class GeneticAlgorithm:
    ...
    def report(self,generation=0,total=0):
        ...
        if(generation==total):
            ...
            #print('\r'*80+"Progress: {num:02d}%".format( num=progress*10)+ " ["+chr(187)*int(progress*5)+chr(183)*(10*5-int(progress*5))+ "]", end = "")
            print('\r'*80+"Progress: {num:02d}%".format( num=progress*10)+ " ["+chr(187)*int(progress*5)+chr(183)*(10*5-int(progress*5))+ "]")
