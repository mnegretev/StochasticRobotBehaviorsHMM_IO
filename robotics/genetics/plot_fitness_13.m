...
load ../test_data_13/fitness_average_reactive.dat
load ../test_data_13/fitness_worst_reactive.dat
load ../test_data_13/fitness_best_reactive.dat
load ../test_data_13/fitness_average_reactive_stochastic.dat
load ../test_data_13/fitness_worst_reactive_stochastic.dat
load ../test_data_13/fitness_best_reactive_stochastic.dat
load ../test_data_13/fitness_average_fsm.dat
load ../test_data_13/fitness_worst_fsm.dat
load ../test_data_13/fitness_best_fsm.dat
%load ../test_data_8/fitness_hmm_human.dat
%load ../test_data_8/fitness_MDP.dat
%load ../test_data_8/fitness_MDP_eight.dat
load ../test_data_13/fitness_state_machine_human.dat
...
figure
plot(i,fitness_best_fsm(i),'r-',i,fitness_best_reactive(i),'k-')
xlabel("Best FSM (red) and Reactive")
ylabel("Fitness")

error_reactive_fsm= fitness_best_reactive - fitness_best_fsm;
figure
plot(error_reactive_fsm)
xlabel("Best Reactive - FSM")
ylabel("Difference")

error_reactive_stochastic= fitness_best_reactive - fitness_best_reactive_stochastic;
figure
plot(error_reactive_stochastic)
xlabel("Best Reactive - Reactive_Stochastic")
ylabel("Difference")
...
%figure
%plot(i,fitness_best_reactive(i),'r+-',i,fitness_best_fsm(i),'kx-',i,fitness_best_reactive_stochastic(i),'b*-',fitness_state_machine_human(i),'g-')
%xlabel("GEN REACTIVE(red), GEN FSM (black), GEN REACTIVE STOCHASTIC (blue),  Human FSM (green)")
%ylabel("Fitness")
