...
(cl:defmethod cl:initialize-instance :after ((m <RepeatedSentence>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RepeatedSentence)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-msg:<RepeatedSentence> is deprecated: use planner_msgs-msg:RepeatedSentence instead.")))

(cl:ensure-generic-function 'sentence-val :lambda-list '(m))
(cl:defmethod sentence-val ((m <RepeatedSentence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_msgs-msg:sentence-val is deprecated.  Use planner_msgs-msg:sentence instead.")
  (sentence m))

(cl:ensure-generic-function 'repeat_time-val :lambda-list '(m))
(cl:defmethod repeat_time-val ((m <RepeatedSentence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_msgs-msg:repeat_time-val is deprecated.  Use planner_msgs-msg:repeat_time instead.")
  (repeat_time m))
