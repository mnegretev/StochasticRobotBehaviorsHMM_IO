...
(cl:defmethod cl:initialize-instance :after ((m <planning_cmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'planning_cmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-srv:<planning_cmd-request> is deprecated: use planner_msgs-srv:planning_cmd-request instead.")))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <planning_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_msgs-srv:params-val is deprecated.  Use planner_msgs-srv:params instead.")
  (params m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <planning_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_msgs-srv:name-val is deprecated.  Use planner_msgs-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<planning_cmd-request>)))
  ...
  "planner_msgs/planning_cmdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'planning_cmd-request)))
  "Returns string type for a service object of type 'planning_cmd-request"
  "planner_msgs/planning_cmdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <planning_cmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'planning_cmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_msgs-srv:<planning_cmd-response> is deprecated: use planner_msgs-srv:planning_cmd-response instead.")))
...
(cl:defmethod args-val ((m <planning_cmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_msgs-srv:args-val is deprecated.  Use planner_msgs-srv:args instead.")
  (args m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<planning_cmd-response>)))
  ...
  "planner_msgs/planning_cmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'planning_cmd-response)))
  "Returns string type for a service object of type 'planning_cmd-response"
  "planner_msgs/planning_cmdResponse")
