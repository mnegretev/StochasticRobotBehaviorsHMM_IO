...
class InputsSrvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InputsSrvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InputsSrvRequest
    let len;
    let data = new InputsSrvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new InputsSrvRequest(null);
...
class InputsSrvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InputsSrvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InputsSrvResponse
    let len;
    let data = new InputsSrvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new InputsSrvResponse(null);
...
module.exports = {
  Request: InputsSrvRequest,
  Response: InputsSrvResponse,
  md5sum() { return 'f39e8e9b737ca0cd747aac4db3741413'; },
  datatype() { return 'svg_ros/InputsSrv'; }
};
