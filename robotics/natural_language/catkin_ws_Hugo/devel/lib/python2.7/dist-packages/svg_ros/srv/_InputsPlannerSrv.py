...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5d().pack(_x.origin_x, _x.origin_y, _x.origin_angRob, _x.dest_x, _x.dest_y))
      _x = self.sensorBool
      length = len(_x)
      ...
      _x = self
      buff.write(_get_struct_i5d2id().pack(_x.num_sensorsInt, _x.angle_sensor_orig, _x.range_angleRob, _x.radiusRob, _x.advance, _x.max_angle, _x.num_steps, _x.select, _x.largest_sensor))
      _x = self.pathNAme
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2i().pack(_x.flgGUI, _x.flg_noise))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.origin_x, _x.origin_y, _x.origin_angRob, _x.dest_x, _x.dest_y,) = _get_struct_5d().unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.num_sensorsInt, _x.angle_sensor_orig, _x.range_angleRob, _x.radiusRob, _x.advance, _x.max_angle, _x.num_steps, _x.select, _x.largest_sensor,) = _get_struct_i5d2id().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.flgGUI, _x.flg_noise,) = _get_struct_2i().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
def _get_struct_2i():
    ...
    return _struct_2i
_struct_i5d2id = None
def _get_struct_i5d2id():
    global _struct_i5d2id
    if _struct_i5d2id is None:
        _struct_i5d2id = struct.Struct("<i5d2id")
    return _struct_i5d2id
