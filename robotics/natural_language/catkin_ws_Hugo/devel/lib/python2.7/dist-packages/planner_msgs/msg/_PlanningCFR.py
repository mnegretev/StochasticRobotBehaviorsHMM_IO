...
"""autogenerated by genpy from planner_msgs/PlanningCFR.msg. Do not edit."""
import sys
...
class PlanningCFR(genpy.Message):
  ...
  _type = "planner_msgs/PlanningCFR"
...
"""
  ...
  _slot_types = ['string','planner_msgs/CFRParams[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = planner_msgs.msg.CFRParams()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
