...
;;;;;;;;;;;NAGOYA 2017 names
	...
	(item (type Objects) (name orange)(zone sink)(image orange_juice)(attributes pick)(pose -3.55 -3.0 0.0))
...
;;;;;;;; LOCATIONS
	...
	(item (type Furniture) (name kitchen_table)(pose -3.55 -3.0 0.0)(possession kitchen)(attributes no_visited))
...
; Furniture definitions
	...
	(item (type Person) (name person) (image person)(zone living_room)(pose -1.87 8.64 0.0))
